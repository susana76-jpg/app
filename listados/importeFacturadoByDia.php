...
if(isset($_GET['fecha'])){
	...
	$query="SELECT SUM(li.importe*li.cantidad) FROM facturas_clientes f JOIN ordenes_reparaciones o ON f.id_orden_reparacion=o.id_orden_reparacion JOIN lineas_presupuesto li ON o.id_presupuesto=li.id_presupuesto WHERE f.fecha=?";
