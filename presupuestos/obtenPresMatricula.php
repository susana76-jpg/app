...
include_once("../connect.php");
    ...
    if( isset($_GET['matricula'])){
        ...
        $query="SELECT p.* FROM presupuestos_clientes p JOIN citas_asignadas ci ON p.id_cita=ci.id_cita JOIN vehiculos_clientes v ON ci.id_vehiculo_cliente=v.id_vehiculo_cliente WHERE v.matricula=?";
