...
include_once("../connect.php");
    ...
    if( isset($_GET['id_presupuesto_cliente'])){
        ...
        $query="SELECT li.* FROM lineas_presupuesto li JOIN presupuestos_clientes pre ON li.id_presupuesto=pre.id_presupuesto_cliente JOIN citas_asignadas ci ON pre.id_cita=ci.id_cita JOIN vehiculos_clientes vh ON ci.id_vehiculo_cliente=vh.id_vehiculo_cliente WHERE pre.id_presupuesto_cliente=?";
